      ...
      <div className="w-screen h-[100vh] relative group p-[4vw]">
        <div className="w-screen h-screen flex items-center justify-center relative group">
          <div className="flex flex-col text-zinc-200">
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transition-all duration-400 group-hover:-translate-x-[48vw] group-hover:-translate-y-[40vh]">
              <img
            ...
            >
              <div className="flex px-[5vh] bg-white/10 rounded-full border border-white/30 backdrop-blur-md items-center cursor-pointer">
            ...
            <div className="text-[34vh] absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transition-all duration-400 group-hover:translate-x-[13vw] group-hover:translate-y-[30vh] group-hover:text-[20vh] leading-[10vh] uppercase font-semibold text-nowrap text-yellow-400">
              Ra đời
            </div>
