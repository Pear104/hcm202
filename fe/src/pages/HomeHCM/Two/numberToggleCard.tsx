...
export const NumberedToggleCard = ({
  number,
  title,
  children,
  defaultOpen = false,
  ...
  return (
    <div className="w-full relative">
      ...
      {number > 1 && (
        <div
          className="absolute left-[1.5vw] top-[-1vw] w-[0.15vw] h-[1vw] bg-red-500 z-0"
      ...
      <button
        ...
        className={`z-20 w-full flex items-center gap-[1.5vw] px-[2vw] py-[1vw] rounded-2xl transition-all duration-300 ease-in-out ${
          isOpen
      ...
      <div
        className={`absolute left-[1.5vw] w-[0.15vw] transition-all duration-500 ease-in-out z-0 ${
