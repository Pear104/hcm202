            ...
            <div className="w-[64vw] space-y-[1vw] mt-[2vw]">
              <div className="rounded-3xl px-[2vw] py-[1vw] border border-zinc-500">
                ...
                <div className="h-0 overflow-hidden">
                  Sức mạnh dân tộc là sự tổng hợp của các yếu tố vật chất và
                  tinh thần, trước hết là sức mạnh của chủ nghĩa yêu nước, ý
                  thức tự lực tự cường, tinh thần đoàn kết và ý chí đấu tranh
                  anh dũng, bất khuất vì độc lập, tự do. Chính những yếu tố này
                  đã giúp dân tộc Việt Nam vượt qua mọi khó khăn, thử thách
              ...
              <div className="bg-red-500 rounded-3xl px-[2vw] py-[1vw]">
                ...
                <div className="h-fit overflow-hidden">
                  ...
                  giới, được hun đúc từ thành quả lý luận và thực tiễn của chủ
                  nghĩa Mác – Lênin, đặc biệt được khẳng định qua thắng lợi vĩ
                  đại của Cách mạng Tháng Mười Nga năm 1917. Đây còn là sức mạnh
                  đến từ phong trào giải phóng dân tộc, phong trào cách mạng của
                  giai cấp công nhân quốc tế, sự tiến bộ vượt bậc của khoa học –
                  kỹ thuật và sự đồng tình, ủng hộ to lớn của nhân dân tiến bộ
                  trên thế giới. Hồ Chí Minh đã sớm xác định cách mạng Việt Nam
                  là một bộ phận khăng khít của cách mạng thế giới và chỉ có thể
                  đi đến thành công khi gắn bó, đoàn kết chặt chẽ với phong trào
                  cách mạng quốc tế. Đây là nhận thức mới mẻ, tiến bộ so với các
                  bậc tiền bối, thể hiện rõ vai trò quyết định của đoàn kết quốc
                  tế đối với thắng lợi của cách mạng Việt Nam.
                </div>
              </div>
            </div>
